...
*** Test Cases ***
tc_WPS_Flashing_Green_Slow_2_4GHz_Default_Primary_SSID
    [Documentation]    tc_WPS_Flashing_Green_Slow_2_4GHz_Default_Primary_SSID
    ...    WPS LED must be in a Flashing Green slow state during the process of associating.
    [Tags]    @TCID=PREMS-TC-7909    @globalid=1597635LED844F    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    [Timeout]
    #Login Web GUI
