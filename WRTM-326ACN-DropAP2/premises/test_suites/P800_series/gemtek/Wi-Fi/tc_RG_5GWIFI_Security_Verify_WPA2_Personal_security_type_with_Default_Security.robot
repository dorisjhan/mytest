...
*** Test Cases ***
tc_RG_5GWIFI_Security_Verify_WPA2_Personal_security_type_with_Default_Security
    [Documentation]    tc_RG_5GWIFI_Security_Verify_WPA2_Personal_security_type_with_Default_Security
    ...
    [Tags]    @TCID=STP_DD-TC-10906    @globalid=1526089    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
