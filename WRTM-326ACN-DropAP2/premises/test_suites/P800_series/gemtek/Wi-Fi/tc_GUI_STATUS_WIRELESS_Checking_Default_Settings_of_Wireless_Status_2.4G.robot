...
${Default_wifi_mode}    802.11bgn
${Default_frequency}    2.4GHz
...
${Default_packets_sent}    4
${Default_packets_received}    0

*** Test Cases ***
tc_GUI_STATUS_WIRELESS_Checking_Default_Settings_of_Wireless_Status_2.4G
    [Documentation]    ttc_GUI_STATUS_WIRELESS_Checking_Default_Settings_of_Wireless_Status_2.4G
    ...
    [Tags]    @TCID=STP_DD-TC-10891    @globalid=1526061    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Hans_Sun
    [Timeout]
    #Login Web GUI
