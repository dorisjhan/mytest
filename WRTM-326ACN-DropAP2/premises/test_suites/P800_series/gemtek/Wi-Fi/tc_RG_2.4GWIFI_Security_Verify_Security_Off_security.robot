...
*** Test Cases ***
tc_RG_2.4GWIFI_Security_Verify_Security_Off_security
    [Documentation]    tc_RG_2.4GWIFI_Security_Verify_Security_Off_security
    ...
    [Tags]    @TCID=STP_DD-TC-10881    @globalid=1526048    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
    ...
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid Without Security Key    wifi_client
