...
*** Test Cases ***
tc_RG_2.4GWIFI_Security_Verify_WPA2_Personal_security_type_with_Custom_Security
    [Documentation]    tc_RG_2.4GWIFI_Security_Verify_WPA2_Personal_security_type_with_Custom_Security
    ...
    [Tags]    @TCID=STP_DD-TC-10864    @globalid=1526031    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
