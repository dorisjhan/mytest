...
*** Test Cases ***
tc_Support_Wireless_Analyzer_2.4G_Wireless_analyzer_information
    [Documentation]    tc_Support_Wireless_Analyzer_2.4G_Wireless_analyzer_information
    ...
    [Tags]    @TCID=STP_DD-TC-10893    @globalid=1526068    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
    login ont    web    ${g_844fb_gui_url}    ${g_844fb_gui_user}    ${g_844fb_gui_pwd}
    #Go to Wireless 2.4GHz Control Page
    ...
    #Select the first WiFi 2.4G SSID and rename
