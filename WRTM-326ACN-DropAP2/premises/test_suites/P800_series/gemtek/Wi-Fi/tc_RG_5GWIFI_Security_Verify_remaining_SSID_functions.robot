...
*** Test Cases ***
tc_RG_5GWIFI_Security_Verify_remaining_SSID_functions
    [Documentation]    tc_RG_5GWIFI_Security_Verify_remaining_SSID_functions
    ...
    [Tags]    @TCID=STP_DD-TC-10910    @globalid=1526093    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
    ...
    #Select WiFi 5G SSID to 5GHz_Guest040D1E
    ...
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Matched Security Key    wifi_client    ${test_ssid}    ${8_characters_security_key}    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${test_gw}    ${test_client_ip}
    #Select 30 characters custom security key
    Wait Until Keyword Succeeds    5x    3s    select_from_list_by_value    web    xpath=//select[@id='id_ssid']    1
    Select Custom Security Key    ${30_characters_security_key}
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Matched Security Key    wifi_client    ${test_ssid}    ${30_characters_security_key}    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${test_gw}    ${test_client_ip}
    ...
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Matched Security Key    wifi_client    ${test_ssid}    ${63_characters_security_key}    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${test_gw}    ${test_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${test_gw}    ${test_client_ip}_pwd}
    ...
    Login Linux Wifi Client To Connect To DUT 5g Ssid Without Security Key    wifi_client    ${test_ssid}    ${test_gw}    ${test_client_ip}


    #Select WiFi 5G SSID to 5GHz_IPTV_SSID040D1E
    Select WiFi 5G SSID    2
    ...
    Select Custom Security Key    ${8_characters_security_key}
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Matched Security Key    wifi_client    ${test_ssid}    ${8_characters_security_key}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${dut_gw}    ${g_844_wifi_client_ip}
    #Select 30 characters custom security key
    Wait Until Keyword Succeeds    5x    3s    select_from_list_by_value    web    xpath=//select[@id='id_ssid']    2
    Select Custom Security Key    ${30_characters_security_key}
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Matched Security Key    wifi_client    ${test_ssid}    ${30_characters_security_key}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${dut_gw}    ${g_844_wifi_client_ip}
    #Select 63 characters custom security key
    ...
    Select Custom Security Key    ${63_characters_security_key}
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Matched Security Key    wifi_client    ${test_ssid}    ${63_characters_security_key}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${dut_gw}    ${g_844_wifi_client_ip}
    ...
    Wait Until Keyword Succeeds    5x    3s    cpe click    web    xpath=//button[contains(., 'Apply')]
    #Verify Wi-Fi connection is successful
    Login Linux Wifi Client To Connect To DUT 5g Ssid Without Security Key    wifi_client    ${test_ssid}    ${dut_gw}    ${g_844_wifi_client_ip}


    #Select WiFi 5G SSID for 5GHz_Operator_2
    Select WiFi 5G SSID    3
    ...
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Type    wifi_client    ${test_ssid}    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type    wifi_client    ${test_ssid}    TKIP    ${dut_gw}    ${g_844_wifi_client_ip}
    Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Security Key    wifi_client    ${test_ssid}    ${unmatched_wifi_pwd}    ${dut_gw}    ${g_844_wifi_client_ip}_pwd}
...
Login Linux Wifi Client To Connect To DUT 5g Ssid With Unmatched Encryption Type
    ...
    [Documentation]    Connect to DUT 5g ssid with unmatched encryption type(choose TKIP/CCMP=AES)
    [Tags]    @AUTHOR=Gemtek_Gavin_Chang
