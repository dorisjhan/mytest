...
*** Test Cases ***
tc_GUI_2.4GWIFI_Security_Verify_input_validation_function
    [Documentation]    tc_GUI_2.4GWIFI_Security_Verify_input_validation_function
    ...   1. login DUT web guit, and go to 2.4GWIFI page
    ...   2. Input invalid Security key, and click apply button
    ...   3. Check warnings will be generated if invalid key is inputted
    [Tags]    @TCID=STP_DD-TC-10883    @globalid=1526050    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Hans_Sun
