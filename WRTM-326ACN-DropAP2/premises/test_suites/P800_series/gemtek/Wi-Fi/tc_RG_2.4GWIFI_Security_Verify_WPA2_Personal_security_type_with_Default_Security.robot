...
*** Test Cases ***
tc_RG_2.4GWIFI_Security_Verify_WPA2_Personal_security_type_with_Default_Security
    [Documentation]    tc_RG_2.4GWIFI_Security_Verify_WPA2_Personal_security_type_with_Default_Security
    ...
    [Tags]    @TCID=STP_DD-TC-10863    @globalid=1526030    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
    ...
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Matched Security Key    wifi_client    ${matched_wifi_pwd}
...
Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Encryption Type
    ...
    [Documentation]    Connect to DUT 2.4g ssid with unmatched encryption type(choose TKIP)
    [Tags]    @AUTHOR=Gemtek_Gavin_Chang
...
Is Ping Fail
    [Arguments]    ${device}    ${gw_ip}
    [Documentation]    To check ping ${dut_gw} is fail
    [Tags]    @AUTHOR=Gemtek_Gavin_Chang
