...
*** Test Cases ***
tc_RG_2.4GWIFI_Security_Verify_WPA_WPA2_Personal_security_type_with_Custom_Security
    [Documentation]    tc_RG_2.4GWIFI_Security_Verify_WPA_WPA2_Personal_security_type_with_Custom_Security
    ...
    [Tags]    @TCID=STP_DD-TC-10858    @globalid=1526025    @DUT=844FB    @DUT=844F    @AUTHOR=Gemtek_Gavin_Chang
    #Login Web GUI
    ...
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Matched Security Key    wifi_client    ${8_characters_security_key}
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Type    wifi_client
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Encryption Type    wifi_client    TKIP
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Key    wifi_client    ${unmatched_wifi_pwd}
    #Select 30 characters custom security key
    Select Custom Security Key    ${30_characters_security_key}
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Matched Security Key    wifi_client    ${30_characters_security_key}
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Type    wifi_client
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Encryption Type    wifi_client    TKIP
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Key    wifi_client    ${unmatched_wifi_pwd}
    ...
    #Verify wireless connection is successful
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Matched Security Key    wifi_client    ${63_characters_security_key}
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Type    wifi_client
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Encryption Type    wifi_client    TKIP
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Key    wifi_client    ${unmatched_wifi_pwd}
    ...
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Matched Security Key    wifi_client    ${8_characters_security_key}
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Type    wifi_client
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Encryption Type    wifi_client    CCMP
    Login Linux Wifi Client To Connect To DUT 2.4g Ssid With Unmatched Security Key    wifi_client    ${unmatched_wifi_pwd}
    #Select 30 characters custom security key
    Select Custom Security Key    ${30_characters_security_key}
    #Verify wireless connection is successful
