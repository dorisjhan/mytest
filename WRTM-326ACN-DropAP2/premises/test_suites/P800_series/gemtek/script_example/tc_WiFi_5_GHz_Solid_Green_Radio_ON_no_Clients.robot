...
*** Test Cases ***
tc_WiFi_5_GHz_Solid_Green_Radio_ON_no_Clients
    [Documentation]    tc_WiFi_5_GHz_Solid_Green_Radio_ON_no_Clients
    ...    Verify if the WiFi 5 GHz LED stay in Solid Green state when WiFi 5 GHz no clients connected.
    ...    When WiFi 5 GHz enable but no clients connected, the WiFi 5GHz LED stay in solid green.
    [Tags]    @TCID=PREMS-TC-7894   @globalid=1597616LED844F    @DUT=844FB  @DUT=844F
    [Timeout]
    #Login Web GUI
