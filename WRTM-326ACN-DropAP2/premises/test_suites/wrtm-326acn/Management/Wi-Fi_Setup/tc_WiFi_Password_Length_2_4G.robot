...
${63byte_ascii_to_64byte_hex}    012345678901234567890123456789012345678901234567890123456789abc   #hex with myvita_2.4G_test1: ced9aae05b3e78034de74dbe434998ec7c11726bfe9c4c09e994a08f898df752
${64byte_hex_only_pwd_from_63byte_ascii}    ced9aae05b3e78034de74dbe434998ec7c11726bfe9c4c09e994a08f898df752
${64byte_hex_ascii_pwd}   012345678901234567890123456789012345678901234567890123456789abc!
${password_box}    Password_24g
...
Verify "Wi-Fi Password" shuld accept 8 characters. NB can connect to HA Devcie
    ...
    # Config SSID
    Config 2.4G Wireless    web    on    ${2.4G_ssid}    0    ${security_type}    ${8byte_pwd}
    ...
    ...    wifi_client  ${2.4G_ssid}  ${8byte_pwd}  ${DEVICES.wifi_client.int}  ${DEVICES.wifi_client.assign_static_ip}  ${g_dut_gw}
...
Verify "Wi-Fi Password" shuld accept 63 characters. NB can connect to HA Devcie
    ...
    # Config SSID
    Config 2.4G Wireless    web    on    ${2.4G_ssid}    0    ${security_type}    ${63byte_pwd}
    ...
    Wait Until Keyword Succeeds    5x    3s    Login Linux Wifi Client To Connect To DUT With Matched Security Key
    ...    wifi_client  ${2.4G_ssid}  ${63byte_pwd}  ${DEVICES.wifi_client.int_2_4g}  ${DEVICES.wifi_client.assign_static_ip}  ${g_dut_gw}
...
Verify "Wi-Fi Password" shuld not accept 64 with ascii characters.
    ...
    # Config SSID
    Config 2.4G Wireless    web    on    ${2.4G_ssid}    0    ${security_type}    ${64byte_hex_ascii_pwd}
    
    ${status} =    Wait Until Keyword Succeeds    5x    3s    get element attribute    web    id=msg_pwd_0@style
    log    ${status}
...
Verify "Wi-Fi Password" shuld accept 64 hex characters.
    ...
    # Config SSID
    Config 2.4G Wireless    web    on    ${2.4G_ssid}    0    ${security_type}    ${64byte_hex_only_pwd_from_63byte_ascii}
    ...
    Wait Until Keyword Succeeds    5x    3s    Login Linux Wifi Client To Connect To DUT With Matched Security Key
    ...    wifi_client  ${2.4G_ssid}  ${63byte_ascii_to_64byte_hex}  ${DEVICES.wifi_client.int_2_4g}  ${DEVICES.wifi_client.assign_static_ip}  ${g_dut_gw}
