...
*** Test Cases ***
tc_WiFi_Authentication_5G_1
    [Documentation]    NB Connect to HA device with Open authentication
    [Tags]    @tcid=WRTM-326ACN-106    @DUT=wrtm-326acn    @AUTHOR=Gemtek_Gavin_Chang
    [Timeout]
...
Change "Authentication " to Open
    ...
    Config 5G Wireless    web    on    ${5g_ssid}    security=open
...
NB can connect to HA Devcie
    ...
    ...    wifi_client  ${5g_ssid}  ${DEVICES.wifi_client.int}  ${DEVICES.wifi_client.assign_static_ip}  ${g_dut_gw}
