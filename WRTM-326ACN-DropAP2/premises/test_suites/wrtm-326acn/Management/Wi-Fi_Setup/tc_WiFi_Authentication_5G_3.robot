...
*** Variables ***
${5g_default_authentication}    wpa2-psk-mixed

*** Test Cases ***
tc_WiFi_Authentication_5G_3
    [Documentation]    Check "5G Authentication" default type is WPA/WPA2 AES mode
    [Tags]    @tcid=WRTM-326ACN-109    @DUT=wrtm-326acn    @AUTHOR=Gemtek_Gavin_Chang
    [Timeout]
...
Check "Authentication" type
    ...
    ${result}    get_selected_list_value    web    security_5g
    Should Be Equal    ${result}    ${5g_default_authentication}
