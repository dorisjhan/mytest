...
*** Test Cases ***
tc_Verify_No_Traffic_Passing_Through_When_Port_Forwarding_Rule_is_Disabled_PPPoE
...
Disabled Default Port Forward Rule and Check No Traffic Passing Through on TCP.
    ...
    \    ${dut_wan_ip} =   Wait Until Keyword Succeeds    20x    5s     Get Wan IP Value From Device SSH Connection    dut1_ssh    pppoe
    \    log    ${dut_wan_ip}
