...
*** Test Cases ***
tc_Static_Connection_MTU_Manual
    [Documentation]    Static mode MTU value should be from 576 to 1492 Bytes, check setting result and meet segment packet size.
    [Tags]    @tcid=WRTM-326ACN-24    @DUT=wrtm-326acn     @AUTHOR=Gemtek_Thomas_Chen
    [Timeout]
    
    
    Configure DUT with WAN Internet connection type to be Static IP mode, and minute MTU size equal 576. 
