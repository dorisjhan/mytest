...
*** Test Cases ***
tc_PPPoE_Connection_Username_and_Password
    [Documentation]    Input right Username and Password of 63 characters. The DUT can connect to PPPoE server.
    [Tags]   @tcid=WRTM-326ACN-31    @DUT=wrtm-326acn     @AUTHOR=Gemtek_Thomas_Chen
    [Timeout]

    #Connect a PPPoE Server on WAN side.
    Configure WAN Internet connection type to be PPPoE mode. Input right Username and Password of 63 characters to dial to PPPoE Server.
