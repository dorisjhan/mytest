...
Configure L2TP including server ip, username, password, Select "Full" mode and save the settings.
    ...
    Config PPTP_L2TP    web    l2tp    ${DEVICES.cisco.gateway}    ${ppp_username}    ${ppp_password}    ${L2TP_TYPE_SMART}    ${L2TP_START_WHEN_BOOT}    ${L2TP_FORCE_ENCRYPTION}
