...
${ppp_password}    test
${L2TP_TYPE_FULL}    full
${L2TP_START_WHEN_BOOT}    True
${L2TP_FORCE_ENCRYPTION}    False

*** Test Cases ***
tc_L2TP_Start_on_Boot_Enabled
    ...
    Reload DUT
    Check L2TP Status Should be "Connected"
...
From Console, Check the L2TP status. Check traffic from lan to vpn internal lan
    ...
    ${dut_wan_ip} =   Wait Until Keyword Succeeds    10x    5s     Get IP Value From Device SSH Connection    dut1_ssh     ${DEVICES.rf1.l2tp_interface}
